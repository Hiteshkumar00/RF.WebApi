...
namespace RF.WebApi.Api.Migrations
{
    ...
    [Migration("20260425164522_AddVoiceTypingToAccount")]
    partial class AddVoiceTypingToAccount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RF.WebApi.Api.Infrastructure.Data.Tables.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "System",
                            IsActive = false,
                            Password = "$2a$11$CHZ4Etpgaprj4m5we7L6tOS5.9dHNJ1ePOeDzElV3i9mqTDAhcz8a",
                            Role = "SuperAdmin",
                            Surname = "User"
                        });
                });
