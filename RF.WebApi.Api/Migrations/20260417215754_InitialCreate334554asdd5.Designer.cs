...
namespace RF.WebApi.Api.Migrations
{
    ...
    [Migration("20260417215754_InitialCreate334554asdd5")]
    partial class InitialCreate334554asdd5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RF.WebApi.Api.Infrastructure.Data.Tables.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "System",
                            IsActive = false,
                            Password = "$2a$11$3nNwjFIgAXkMMcKsh2rONuq0GqXPSuwVSMLRWk5IJxQ3zYgTQfxWG",
                            Role = "SuperAdmin",
                            Surname = "User"
                        });
                });
