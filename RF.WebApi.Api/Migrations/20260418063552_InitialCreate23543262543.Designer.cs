...
namespace RF.WebApi.Api.Migrations
{
    ...
    [Migration("20260418063552_InitialCreate23543262543")]
    partial class InitialCreate23543262543
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RF.WebApi.Api.Infrastructure.Data.Tables.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "System",
                            IsActive = false,
                            Password = "$2a$11$skTKQnJZJjyyvxgFPm/1K.bfeyl6pTHe3FeXwkSpzzcWs9GqWIJmq",
                            Role = "SuperAdmin",
                            Surname = "User"
                        });
                });
